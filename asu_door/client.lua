                ...
                if (distanceToVehicle < minDistance) and (getDoor(lookAtVehicle)) then
                    if (not isVehicleLocked(lookAtVehicle)) then
                        ...
                        if (checkDoor ~= 4 ) then
                            ...
                            dxDrawRoundedRectangle ( screenWidth/2 - 30, screenHeight/2 + 150, 55, 50, 13, tocolor( 0, 0, 0 ));
                            
                            if (doorRatio <= 0) then
                                dxDrawText("" .. doorName .. "\n Açmak için  tuşa basın.", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2+450, tocolor(255, 255, 255, 255), 0.7, robotob, "center", "center", false, false, false, true, true);
                                dxDrawText("E", screenWidth/2, screenHeight/2, screenWidth/2-5, screenHeight/2+350, tocolor(245,102,111), 1.5, robotob, "center", "center", false, false, false, true, true);
                            else
                                dxDrawText("" .. doorName .. "\n Kapatmak için  tuşa basın.", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2+450, tocolor(255, 255, 255, 255), 0.7, robotob, "center", "center", false, false, false, true, true);
                                dxDrawText("E", screenWidth/2, screenHeight/2, screenWidth/2-5, screenHeight/2+350, tocolor(245,102,111), 1.5, robotob, "center", "center", false, false, false, true, true);
                            end 
                        end
                    else
                        dxDrawRoundedRectangle ( screenWidth/2 - 100, screenHeight/2 - 8, 200, 16, 10, tocolor( 0, 0, 0, 90 ));
                        dxDrawText("#FF0000 Bu araba kilitli!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 0.7, robotob, "center", "center", false, false, false, true, true);
                    end           
                end
            end
        end
