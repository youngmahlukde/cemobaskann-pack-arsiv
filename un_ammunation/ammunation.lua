...
function mermiOnayla(thePlayer, cmd)
	...
	if mermiTutari then
		if exports.un_global:hasMoney(thePlayer, mermiTutari) then
			...
			exports.un_global:takeMoney(thePlayer, mermiTutari)
			for i = 1, sarjorMiktari do
				give, error = exports.un_global:giveItem(thePlayer, 116, silahTuru..":"..mermiMiktari..":Ammo for "..getWeaponNameFromID(silahTuru))
			end
