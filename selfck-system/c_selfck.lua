	...
	if requested~="requested" then
		if (logged==1) then    
			if (ckWindow==nil) then
				...
				lWelcome = guiCreateLabel(114, 25, 186, 16, "Self-CK Panel - OWNER", false, ckWindow)
				...
				lCause = guiCreateLabel(111, 51, 199, 25, "Lütfen ölüm nedeninizi açıklayın:", false, ckWindow)
